...
st.write("1. Enter your client credential. You may get one from your [settings page](https://osu.ppy.sh/home/account/edit)")
...
if uploaded_file is None:
    ...
    for pic in sorted(os.listdir(covers_dir)):
